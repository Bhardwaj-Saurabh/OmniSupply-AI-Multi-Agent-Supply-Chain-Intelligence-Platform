"""
Non-destructive schema migration: ALTER is_returned column from INTEGER to BOOLEAN.
...
print("=" * 80)
print("SAFE Schema Migration: is_returned INTEGER → BOOLEAN")
print("=" * 80)
print("\nThis migration will:")
...
try:
    ...
    print("  - This operation is REVERSIBLE (we can convert back if needed)")
    print("=" * 80)
